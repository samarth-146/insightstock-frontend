...
//   // Fetch subscriber IDs when the popup opens
//   useEffect(() => {
//     if (showPopup) {
//       fetchSubscriberIds()
//     }
...
//   const fetchSubscriberIds = async () => {
//     setLoading(true)
//     setError(null)
//     setSubscribers([]) // Reset subscribers before fetching new ones
//     let userId = localStorage.getItem("userId")
//     try {
//       const response = await fetch(`http://localhost:8080/users/${userId}/subscriptions`)
//       if (!response.ok) {
//         throw new Error("Failed to fetch subscriber IDs")
//       }
//       const ids = await response.json()
//       console.log(ids)
//       setSubscriberIds(ids)
//       fetchSubscriberDetails(ids) // Fetch user details based on IDs
//     } catch (err) {
...
//   // Fetch subscriber details for each user ID
//   const fetchSubscriberDetails = async (ids) => {
//     try {
//       const detailsPromises = ids.map(async (id) => {
//         const res = await fetch(`http://localhost:8080/users/${id}`) // Replace with actual API
//         if (!res.ok) throw new Error(`Failed to fetch user ${id}`)
//         return res.json()
//       })
//       const details = await Promise.all(detailsPromises)
//       setSubscribers(details)
//       console.log(details)
//     } catch (err) {
...
//   const handleSubscriberClick = (id) => {
//     navigate(`/profile/${id}`)
//     setShowPopup(false)
//   }
